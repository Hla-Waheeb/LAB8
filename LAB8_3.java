...
public class LAB8_3<E> {
        ...
        public boolean equals(Object that) {
            if (!(that instanceof LAB8_3))
                return false;
            LAB8_3<E> other = (LAB8_3<E>) that;
            if (header == null) {
    ...
    public static class TEST {
        public static void main(String[] args) {
            LAB8_3<Integer>dll1=new LAB8_3<Integer>();

            dll1.addFrist(100);
            dll1.addFrist(100);

            LAB8_3<Integer>dll2=new LAB8_3<Integer>();
            dll2.addFrist(100);
            dll2.addFrist(200);

            LAB8_3<Integer>dll3=new LAB8_3<Integer>();
            dll1.addFrist(42);
            LAB8_3<String>blankList1=new LAB8_3<String>();

            LAB8_3<String>blankList2=new LAB8_3<String>();
